...
export async function seedGameData() {
  ...
  await db.insert(npcs).values([
    { name: "Старый Эдвин", title: "Наставник новичков", locationId: 1, greeting: "А новый герой! В лесах опасно но с моими советами ты справишься. Начни с охоты на кабанов.", advice: "Не забывай распределять очки после повышения уровня! И всегда блокируй зону по которой монстр бьёт." },
    { name: "Моргана", title: "Хранительница леса", locationId: 2, greeting: "Тёмный лес полон опасностей путник. Ты силён но будь осторожен.", advice: "Когда идёшь в лес защищай грудь и голову — твари бьют сверху." },
    { name: "Грязный Гарри", title: "Проводник топи", locationId: 3, greeting: "Ещё один смельчак решил пройти через топи? Не суйся в воду без защиты.", advice: "На болотах главное — ноги. Твари ползают и кусают снизу." },
    { name: "Каменный Джек", title: "Шахтёр-ветеран", locationId: 4, greeting: "Неплохо ты добрался вояка. На плато ветер сильный смотри под ноги!", advice: "Големы медленные — уворачивайся. Их слабость в ногах." },
    { name: "Лира", title: "Дух руин", locationId: 5, greeting: "Ты чувствуешь магию? Руины хранят знания и чудовищ.", advice: "Нежить боится атак в голову — без неё они теряются." },
    { name: "Белый Клык", title: "Вожак клана", locationId: 6, greeting: "Мало кто забирается так высоко. Лёд не прощает ошибок.", advice: "В холода блокируй грудь и живот — холодные твари бьют в центр." },
    { name: "Пламенный Кузнец", title: "Мастер огня", locationId: 7, greeting: "Жарко тут? Ха! Если выживешь расскажу о легендарном оружии.", advice: "Демоны атакуют пояс — прикрой его в первую очередь." },
    { name: "Туманный Странник", title: "Проводник душ", locationId: 8, greeting: "Туман густой как кисель... Я брожу тут века.", advice: "В ущелье блокируй ноги. Призраки любят атаковать снизу." },
    { name: "Хранитель Тайн", title: "Библиотекарь", locationId: 9, greeting: "Ты дошёл до храма. Мало кому это удаётся.", advice: "Стражи бьют в голову и ноги — выбери зону и держись её." },
    { name: "Эфириус", title: "Сущность", locationId: 10, greeting: "Ты достиг границы миров. Докажи что достоин.", advice: "В эфире нет правил. Читай атаки врага и адаптируйся." },
  ]);
